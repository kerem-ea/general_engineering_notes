...
A heat engine operates in a cycle to convert heat into work:
...
By the Second Law (Kelvin-Planck statement), a heat engine cannot convert all heat into work; waste heat must be rejected ($Q_c > 0 \implies \eta < 1$).
