...
- **Average Kinetic Energy (per mole):**
  $$
  \overline{KE} = \frac{1}{2} M u_{\text{rms}}^2 = \frac{3}{2} RT
  $$
- **Root-Mean-Square Speed ($u_{\text{rms}}$):**
  $$
...
- At any given temperature, all gases share the **same average kinetic energy**; lighter molecules move at **higher speeds** ($u_{\text{rms}}$).
