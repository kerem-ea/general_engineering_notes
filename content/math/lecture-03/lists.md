...
An **ordered tuple** is a finite ordered sequence of elements enclosed in parentheses:
...
- **Duplicates are distinct:** $(1, 1, 2) \neq (1, 2)$.

## Tuples vs. Lists

While both maintain order and allow duplicate entries:
